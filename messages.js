// messages.js
// content from https://github.com/ngerakines/commitment/blob/master/commit_messages.txt
//
exports.messages = [
  ...
  "prodigic, WE WENT OVER THIS. EXPANDTAB.",
  "prodigic, WE WENT OVER THIS. C++ IO SUCKS.",
  "Some shit.",
  "See last commit",
  "[no message]",
  "add actual words",
  ...
  "Gross hack because geekfreak doesn't know how to code",
  ...
  "geekfreak broke the regex, lame",
  "small is a real HTML tag, who knew.",
  "WTF is this.",
  "Do things better, faster, stronger",
  "Fixed a bug cause geekfreak said to",
  ...
  "needs more cow bell",
  "Switched off unit test 15X because the build had to go out now and there was no time to fix it properly.",
  "Updated",
  ...
  "Fixed the build.",
  "Fixing geekfreak's bug.",
  "Fixing geekfreak's bugs.",
  "various changes",
  ...
  "This is the last time we let geekfreak commit ascii porn in the comments.",
  ...
  "TDD: 1, Me: 0",
  "Yep, geekfreak was right on this one.",
  ...
  "...",
  "GIT :/",
  "stopped caring 8,23X commits ago",
  "Testing in progress ;)",
  "Fixed Bug",
  "Fixed errors",
  ...
  "LAST time, geekfreak, /dev/urandom IS NOT a variable name generator...",
  ...
  "It only compiles every 2,5X tries... good luck.",
  "This will definitely break in 2020,89X (TODO)",
  "Issue #10X is now Issue #30X",
